...
namespace BleakwindBuffet.DataTests.UnitTests.EntreeTests
{
    public class ThalmorTripleTests
    {
                                                                    ...
                                                                    bool includeBacon, bool includeEgg)
        {
            ...
            if (includeBun && includeKetchup && includeMustard && includePickle && includeCheese && includeBacon && includeEgg) Assert.Empty(tt.SpecialInstructions);
        }
